...
//            throw new RuntimeException("Token失效请重新登录");
            responseOutWithJson(response, e.getMessage());
    ...
    protected void responseOutWithJson(ServletResponse response,
        ...
        res.put("messageg", responseObject);
        res.put("code", 500);
        JSONObject responseJSONObject = JSONObject.parseObject(JSON.toJSONString(res));
