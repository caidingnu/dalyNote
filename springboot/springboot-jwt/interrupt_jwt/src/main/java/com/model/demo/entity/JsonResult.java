...
public class JsonResult implements Serializable {
     ...
     * @return
     */
    public static JsonResult build(String msg, String code, Object data) throws Exception {
        if(msg==null||msg.trim().length()<1) throw  new Exception("消息为空");
        if(code==null) throw  new Exception("code为空");
     ...
     * @return
     */
    public static JsonResult build(Object msg, String code, Object data) throws Exception {
        String str = "";
        ...
        if(str==null||str.trim().length()<1) throw  new Exception("消息为空");
        if(code==null) throw  new Exception("code为空");
        return new JsonResult(code, data, str);
    }
     ...
     * @return
     */
    public static JsonResult buildSuccess(Object data, String msg) throws Exception {
        if(msg==null||msg.trim().length()<1) throw  new Exception("消息为空");
