...
public class UploadController {
    ...
    @ResponseBody
    public Object singleFileUpload(@RequestParam(value = "file",required = false) MultipartFile file, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("code", "200");
            String data = pdf2word.pdf2word(getNowDate()+"/"+ uuid + suffixName);
            map.put("data",data);
