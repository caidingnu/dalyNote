package com.cdn.common.controller;

import com.cdn.common.entity.Base;
import com.cdn.common.entity.Employee;
 ...
 */
public class ExeExportController {

    /**
     * ▲▲▲★★★★★
     * jx:mergeCells(cols="1", rows="employees.employeesList.size()", lastCell="A2")
     * 合并单元前提，不能手动合并
     * ▲▲▲★★★★★
     */

    public static void main(String[] args) {
        new ExeExportController().userCommond();
    }
